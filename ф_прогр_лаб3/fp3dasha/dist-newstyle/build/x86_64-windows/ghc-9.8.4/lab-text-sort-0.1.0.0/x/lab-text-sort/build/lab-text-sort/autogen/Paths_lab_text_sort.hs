...
-- at runtime using the environment variable lab_text_sort_bindir.
...
-- environment variable lab_text_sort_libdir.
...
-- using the environment variable lab_text_sort_dynlibdir.
...
-- runtime using the environment variable lab_text_sort_datadir.
...
-- variable lab_text_sort_libexedir.
...
-- using the environment variable lab_text_sort_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.8.4-4f9e\\lab-text-sort-0.1.0.0-inplace-lab-text-sort"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.8.4-4f9e"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.8.4-4f9e\\lab-text-sort-0.1.0.0"
libexecdir = "C:\\cabal\\lab-text-sort-0.1.0.0-inplace-lab-text-sort\\x86_64-windows-ghc-9.8.4-4f9e\\lab-text-sort-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "lab_text_sort_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "lab_text_sort_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "lab_text_sort_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "lab_text_sort_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "lab_text_sort_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "lab_text_sort_sysconfdir") (\_ -> return sysconfdir)
